                        ...
                        <form action="{{ route('pendaftaran.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="email" value="{{ old('email') }}" placeholder="Email Aktif " class="form-control @error('email') is-invalid @enderror">
                                </div>
                            </div>
                            <i class="text-danger fw-bold">Pastikan Email Benar!!</i>
                            @error('email')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="program" class="form-control @error('program') is-invalid @enderror"
                                        required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="penghasilan_ayah"
                                        ...
                                        <option value="0" {{ old('penghasilan_ayah') == '0' ? 'selected' : '' }}>Tidak Bekerja
                                        </option>
                                        <option value="1000000" {{ old('penghasilan_ayah') == '1000000' ? 'selected' : '' }}>
                                            Rp.1.000.000 - Rp.2.000.000</option>
                                        <option value="2000000" {{ old('penghasilan_ayah') == '2000000' ? 'selected' : '' }}>
                                            Rp.2.000.000 - Rp.3.000.000</option>
                                        <option value="3000000" {{ old('penghasilan_ayah') == '3000000' ? 'selected' : '' }}>
                                            Rp.3.000.000 - Rp.5.000.000</option>
                                        <option value="5000000" {{ old('penghasilan_ayah') == '5000000' ? 'selected' : '' }}>
                                            Rp.5.000.000 - Rp.10.000.000</option>
                                        <option value="10000000" {{ old('penghasilan_ayah') == '10000000' ? 'selected' : '' }}>Lebih dari Rp.10.000.000</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="penghasilan_ibu"
                                        ...
                                        <option value="0" {{ old('penghasilan_ibu') == '0' ? 'selected' : '' }}>Tidak Bekerja
                                        </option>
                                        <option value="1000000" {{ old('penghasilan_ibu') == '1000000' ? 'selected' : '' }}>
                                            Rp.1.000.000 - Rp.2.000.000</option>
                                        <option value="2000000" {{ old('penghasilan_ibu') == '2000000' ? 'selected' : '' }}>
                                            Rp.2.000.000 - Rp.3.000.000</option>
                                        <option value="3000000" {{ old('penghasilan_ibu') == '3000000' ? 'selected' : '' }}>
                                            Rp.3.000.000 - Rp.5.000.000</option>
                                        <option value="5000000" {{ old('penghasilan_ibu') == '5000000' ? 'selected' : '' }}>
                                            Rp.5.000.000 - Rp.10.000.000</option>
                                        <option value="10000000" {{ old('penghasilan_ibu') == '10000000' ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="status_ayah"
                                        class="form-select @error('status_ayah') is-invalid @enderror" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="alamat_orang_tua"
                                        class="form-control @error('alamat_orang_tua') is-invalid @enderror" rows="2"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nomor_hp_orang_tua" value="{{ old('nomor_hp_orang_tua') }}"
                                        class="form-control @error('nomor_hp_orang_tua') is-invalid @enderror" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="hubungan_wali" id="hubungan_wali"
                                        class="form-select @error('hubungan_wali') is-invalid @enderror">
